...
```typescript
import { ChainId, Token, TokenAmount, Pair } from 'protoss-exchange-sdk'
...
Computes the pair address for the passed [Tokens](https://github.com/protoss/protoss-exchange-sdk/blob/main/doc/token.md).
