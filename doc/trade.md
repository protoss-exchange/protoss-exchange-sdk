...
```typescript
import { ChainId, Token, TokenAmount, Pair, TradeType, Route } from 'protoss-exchange-sdk'
...
The [path](https://github.com/10k-swap/protoss-exchange-sdk/blob/main/doc/route.md#path) property of the route should be passed as the path parameter to router functions.
