...
export declare function getPairAddress(tokenA: Token, tokenB: Token): string;
export declare function isEqualAddress(addressA: string, addressB: string): boolean;
export declare function sortsBefore(addressA: string, addressB: string): boolean;
