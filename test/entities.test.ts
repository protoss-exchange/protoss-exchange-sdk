  ...
  DECIMAL_PERMUTATIONS.forEach(decimals => {
    describe(`decimals permutation: ${decimals}`, () => {
      ...
      it('Route', () => {
        ...
        expect(route.path).toEqual(tokens.concat([ETH]))
      ...
      describe('Trade', () => {
        ...
        it('TradeType.EXACT_INPUT', () => {
          ...
          const expectedOutputAmount = new TokenAmount(ETH, '1662497915624478906')
        ...
        it('TradeType.EXACT_OUTPUT', () => {
          const outputAmount = new TokenAmount(ETH, '1662497915624478906')
      ...
      it('TokenAmount', () => {
        const amount = new TokenAmount(ETH, '1234567000000000000000')
